...
namespace UnityEditor.VisualScripting.Editor
{
    public class Port : Unity.GraphElements.Port, IDropTarget, IBadgeContainer
    {
        ...
        static void OnDropCallback(Store store, Unity.GraphElements.Edge edge)
        {
        ...
        public override void Connect(Unity.GraphElements.Edge edge)
        {
            base.Connect(edge);
            EnableInClassList("disconnected", !connected);
        }

        public override void Disconnect(Unity.GraphElements.Edge edge)
        {
