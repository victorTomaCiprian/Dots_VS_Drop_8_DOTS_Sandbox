...
using Edge = UnityEditor.VisualScripting.Editor.Edge;
using IEdgeModel = UnityEditor.VisualScripting.GraphViewModel.IEdgeModel;
...
namespace VisualScripting.Editor.Elements
{
    ...
    public class EdgeControl : Unity.GraphElements.EdgeControl
    {
