    ...
    public sealed class VseUIController
    {
        ...
        void PartialRebuild(State state)
        {
            ...
            using (var partialRebuilder = new UIPartialRebuilder(state, CreateElement, RemoveFromGraphView))
            {
                ...
                Dictionary<PortModel, Unity.GraphElements.Port> allPorts = m_GraphView.ports.ToList().ToDictionary(p => p.userData as PortModel);
        ...
        bool RestoreEdge(IEdgeModel edge, Dictionary<PortModel, Unity.GraphElements.Port> portsByModel)
        {
        ...
        void AddToGraphView(GraphElement graphElement, Unity.GraphElements.Scope scope = null)
        {
        ...
        public static bool IsNodeConnectedTo(Unity.GraphElements.Node node,
            Unity.GraphElements.Node otherNode)
        {
            if (node == null)
                return false;
            ...
            HashSet<Unity.GraphElements.Node> visitedNodes =
                new HashSet<Unity.GraphElements.Node>();
