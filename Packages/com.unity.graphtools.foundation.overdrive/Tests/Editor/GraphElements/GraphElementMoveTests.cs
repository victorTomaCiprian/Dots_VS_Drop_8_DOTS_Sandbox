...
namespace Unity.GraphElementsTests
{
    public class GraphElementMoveTests : GraphViewTester
    {
        ...
        Vector2 k_SelectionOffset = new Vector2(10, 10);
        ...
        public override void SetUp()
        {
            ...
            node = CreateNode("Movable element", k_NodePos, 0, 1);

            // Add the minimap.
            var miniMap = new MiniMap();
            miniMap.SetPosition(k_MinimapRect);
        ...
        public IEnumerator MovableElementCanBeDragged()
        {
            ...
            Assert.AreEqual(k_NodePos.x + offset.x, node.layout.x);
            Assert.AreEqual(k_NodePos.y + offset.y, node.layout.y);
        ...
        public IEnumerator LocallyScaledElementMovesAtSameSpeed()
        {
            ...
            return MovableElementCanBeDragged();
        }
        ...
        {
            Vector2 worldNodePos = graphView.contentViewContainer.LocalToWorld(k_MinimapRect.position);
            Vector2 start = worldNodePos + k_SelectionOffset;
            Vector2 offset = new Vector2(10, 10);
        ...
        public IEnumerator PanSpeedsAreAsExpected()
        {
            ...
            Vector2 dummyMousePos = new Vector2(SelectionDragger.k_PanAreaWidth, SelectionDragger.k_PanAreaWidth);

            // We do a mouseDown just so the manipulator has a GraphView set.
            helpers.MouseDownEvent(dummyMousePos);
            yield return null;
            ...
            helpers.MouseUpEvent(dummyMousePos);
