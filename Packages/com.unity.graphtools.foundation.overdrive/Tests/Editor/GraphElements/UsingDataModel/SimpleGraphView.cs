...
namespace Editor.UsingDataModel.NoPresenters
{
    class SimpleGraphView : GraphView
    {
        ...
        private void AddToGroupNode(DropdownMenuAction a)
        {
            var groupNode = ScriptableObject.CreateInstance<MathGroupNode>();
        ...
        private void RemoveFromGroupNode(DropdownMenuAction a)
        {
            foreach (ISelectable s in selection)
            {
                var node = s as Node;
        ...
        private void AddToScope(DropdownMenuAction a)
        {
        ...
        private void RemoveFromScope(DropdownMenuAction a)
        {
            foreach (ISelectable s in selection)
            {
                var element = s as GraphElement;
        ...
        private void AddToPlacematAction(DropdownMenuAction a)
        {
            AddToPlacemat();
        }
