        ...
        public void Test_MoveElementsActionForNodes([Values] TestingMode mode)
        {
            ...
            TestPrereqActionPostreq(mode,
                () =>
                {
                    ...
                    return new MoveElementsAction(newPosition0, new[] {GetNode(0)}, null, null, null);
                },
                () =>
                {
                    Assert.That(GetNodeCount(), Is.EqualTo(4));
            ...
            TestPrereqActionPostreq(mode,
                () =>
                {
                    ...
                    Assert.That(GetNode(2).Position, Is.EqualTo(Vector2.zero));
                    Assert.That(GetNode(3).Position, Is.EqualTo(Vector2.zero));
                    return new MoveElementsAction(newPosition1, new[] {GetNode(1)}, null, null, null);
                },
                () =>
                {
                    Assert.That(GetNodeCount(), Is.EqualTo(4));
            ...
            TestPrereqActionPostreq(mode,
                () =>
                {
                    ...
                    Assert.That(GetNode(2).Position, Is.EqualTo(Vector2.zero));
                    Assert.That(GetNode(3).Position, Is.EqualTo(Vector2.zero));
                    return new MoveElementsAction(newPosition2, new[] {GetNode(2)}, null, null, null);
                },
                () =>
                {
                    Assert.That(GetNodeCount(), Is.EqualTo(4));
            ...
            TestPrereqActionPostreq(mode,
                () =>
                {
                    ...
                    Assert.That(GetNode(2).Position, Is.EqualTo(newPosition2));
                    Assert.That(GetNode(3).Position, Is.EqualTo(Vector2.zero));
                    return new MoveElementsAction(deltaAll, new[] {GetNode(0), GetNode(1), GetNode(2), GetNode(3)}, null, null, null);
                },
                () =>
                {
                    Assert.That(GetNodeCount(), Is.EqualTo(4));
        ...
        public void Test_MoveElementsActionForStickyNodes([Values] TestingMode mode)
        {
            ...
            TestPrereqActionPostreq(mode,
                () =>
                {
                    ...
                    return new MoveElementsAction(newStickyPosition.position - origStickyPosition.position, null, null, new[] {stickyNote}, null);
                },
                () =>
                {
                    Assert.That(GetNodeCount(), Is.EqualTo(0));
