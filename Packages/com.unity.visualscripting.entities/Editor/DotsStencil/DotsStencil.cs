...
using Port = Unity.GraphElements.Port;
...
namespace DotsStencil
{
    public class DotsStencil : Stencil
    {
        ...
        static readonly HighLevelNodeImguiVisitor k_PropertyVisitor = new DotsNodeImguiVisitor();
        ...
        public override void CreateNodesFromPort(Store store, IPortModel portModel, Vector2 position,
        ...
        public override bool GetPortCapacity(PortModel portModel, out Port.Capacity capacity)
        {
