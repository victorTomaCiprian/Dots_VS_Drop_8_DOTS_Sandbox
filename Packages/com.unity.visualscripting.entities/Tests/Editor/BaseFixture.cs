...
namespace UnityEditor.VisualScriptingTests
{
    ...
    public abstract class BaseFixture
    {
        ...
        protected virtual Type CreatedGraphType => typeof(DotsStencil.DotsStencil);
        ...
        {
            if (m_BurstCompilationOption == null)
                m_BurstCompilationOption = BurstCompiler.Options.EnableBurstCompilation;
        ...
        public virtual void TearDown()
        {
            ...
            BurstCompiler.Options.EnableBurstCompilation = m_BurstCompilationOption ?? true;
        }
        ...
        {
            return GraphModel.StackModels.Cast<StackBaseModel>().Where(x => !(x is FunctionModel) && x.InputPorts.All(i => !i.Connected));
        }
        ...
        static IEnumerable<VariableNodeModel> GetFloatingVariableModels(IGraphModel graphModel)
        {
            return graphModel.NodeModels.OfType<VariableNodeModel>().Where(v => v.OutputsByDisplayOrder.All(p => !p.Connected));
        }
